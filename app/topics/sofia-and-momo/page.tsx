...
export default function SofiaAndMomo() {
  ...
  const fetchTopicData = async () => {
    setLoading(true);
    try {
      const response = await fetch(`/json_files/sofia_and_momo_${selectedLanguage}.json`);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-300/40 via-white to-purple-300/40">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto mb-6">{topicData?.description || 'Learn about Sofia and her cat Momo'}</p>
        ...
        <div className="flex justify-center mb-8">
          <div className="backdrop-blur-xl bg-white/40 border border-white/30 rounded-3xl p-6 shadow-xl">
            <Image src="/cartoons/girl_and_boy_driving_car.svg" alt="Sofia and Momo Illustration" width={200} height={200} className="object-contain" />
          </div>
        </div>
