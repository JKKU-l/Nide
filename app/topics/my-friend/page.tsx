...
export default function MyFriend() {
  ...
  const fetchTopicData = async () => {
    setLoading(true);
    try {
      const response = await fetch(`/json_files/my_friend_${selectedLanguage}.json`);
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="text-center mb-10 px-2">
          ...
          <p className="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto mb-6 px-4">
            {topicData?.description || 'Learn how to describe your friends and their personalities'}
          </p>
