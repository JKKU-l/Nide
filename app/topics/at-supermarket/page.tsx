...
export default function AtSupermarket() {
  ...
  const fetchTopicData = async () => {
    setLoading(true);
    try {
      const response = await fetch(`/json_files/at_supermarket_${selectedLanguage}.json`);
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto mb-6">
            {topicData?.description || 'Learn shopping vocabulary and grocery items'}
          </p>
