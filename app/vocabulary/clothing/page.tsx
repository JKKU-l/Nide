...
export default function ClothingVocabulary() {
  ...
  const fetchVocabularyData = async (lang: string) => {
    setLoading(true);
    try {
      const response = await fetch(`/json_files/vocabulary_clothing_${lang}.json`);
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-300/40 via-white to-pink-300/40">
        <Navbar />
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-purple-700">Clothing</span>
          </div>
          <h1 className="text-4xl font-black text-slate-900 mb-3">
            Clothing
          </h1>
          <p className="text-slate-600 max-w-2xl mx-auto">
            Learn essential German vocabulary for clothing items, from everyday wear to special occasions.
          </p>
        </div>
          ...
          {vocabularyData?.sections.map((section, sectionIndex) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900">Clothing Items</h2>
              </div>
        ...
        <div className="mt-12 text-center">
          <div className="backdrop-blur-xl bg-white/40 border border-white/30 rounded-3xl p-8 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="space-y-2">
                <h3 className="font-bold text-purple-700">👗 Daily Outfits</h3>
                <p className="text-sm text-slate-600">
                  Practice describing your daily outfits using the clothing vocabulary. Start with simple sentences.
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-bold text-purple-700">🛍️ Shopping Context</h3>
                <p className="text-sm text-slate-600">
                  Learn phrases for shopping clothes, like "Ich suche eine Hose" (I'm looking for pants).
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-bold text-purple-700">🎭 Gender Practice</h3>
                <p className="text-sm text-slate-600">
                  Focus on memorizing the articles (der/die/das) - they're essential for proper German grammar.
                </p>
              </div>
            </div>
          </div>
