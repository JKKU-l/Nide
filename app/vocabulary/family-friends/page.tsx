...
export default function FamilyFriendsVocabulary() {
  ...
  const fetchVocabularyData = async (lang: string) => {
    setLoading(true);
    try {
      const response = await fetch(`/json_files/vocabulary_family_friends_${lang}.json`);
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-300/40 via-white to-rose-300/40">
        <Navbar />
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-pink-100 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-pink-700">Family & Friends</span>
          </div>
          <h1 className="text-4xl font-black text-slate-900 mb-3">
            Family and Friends
          </h1>
          <p className="text-slate-600 max-w-2xl mx-auto">
            Learn essential German vocabulary for family members, relationships, and friends.
          </p>
        </div>
          ...
          {vocabularyData?.sections.map((section, sectionIndex) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900">Family & Friends Vocabulary</h2>
              </div>
        ...
        <div className="mt-12 text-center">
          <div className="backdrop-blur-xl bg-white/40 border border-white/30 rounded-3xl p-8 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="space-y-2">
                <h3 className="font-bold text-pink-700">👪 Family Tree</h3>
                <p className="text-sm text-slate-600">
                  Practice describing your family: "Das ist meine Familie" (This is my family).
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-bold text-pink-700">👋 Introductions</h3>
                <p className="text-sm text-slate-600">
                  Introduce family members: "Das ist mein Vater" (This is my father).
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-bold text-pink-700">💕 Relationships</h3>
                <p className="text-sm text-slate-600">
                  Talk about friends: "Sie ist meine Freundin" (She is my friend/girlfriend).
                </p>
              </div>
            </div>
          </div>
